...
class CandidateServiceTest {
        ...
        void priceCandidate_profitGatePass_setsDraftReady() {
                ...
                CandidateService service = new CandidateService(
                                candidateRepo, pricingRepo, calculator, gateService, flags, transitions);
                ...
                PricingResult result = service.priceCandidate(1L, new BigDecimal("145"), null);
        ...
        void priceCandidate_profitGateFail_setsRejected() {
                ...
                PricingResult result = service.priceCandidate(2L, new BigDecimal("145"), null);
        ...
        void priceCandidate_cashGateFail_setsRejected() {
                ...
                PricingResult result = service.priceCandidate(3L, new BigDecimal("145"), null);
